...
* README.md - этот файл
* matrix0.jison - пустой файл для грамматик
* matrix1.jison - лексемы языка МАТ
* matrix2.jison - грамматические правила языка МАТ
* matrix3.jison - пример интерпретатора с языка МАТ
* matrix4.jison - пример компилятора с языка МАТ
* test4.js - пример программы, использующей компилятор
* program.mat - пример программы на языке МАТ
* program32.mat - второй пример программы на языке МАТ
* jison pres.pptx - презентация выступления
